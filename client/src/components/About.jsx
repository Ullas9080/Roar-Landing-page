...
useEffect(() => {
  const ctx = gsap.context(() => {
    ...
    gsap.set(
      [".about-header", ".mission-card", ".vision-card", ".value-card", ".bg-glow"],
    ...
    // Glow background slower (deep parallax)
    gsap.to(".bg-glow", {
      y: -200,
      ease: "none",
      scrollTrigger: {
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
              ...
              >
                <div
                  className={`absolute -top-4 left-1/2 -translate-x-1/2 w-16 h-8 rounded-full ${
                    value.color === "orange" ? "bg-orange-400" : "bg-gray-100"
                  }`}
                />
                ...
                <div
                  className={`absolute -bottom-4 left-1/2 -translate-x-1/2 w-16 h-8 rounded-full ${
                    value.color === "orange" ? "bg-orange-700" : "bg-gray-200"
                  }`}
                />
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-20 justify-items-center">
          <MissionVisionCard
            title="Our Mission"
            text="Empowering youth with real opportunities that turn talent into measurable impact."
          />
          <MissionVisionCard
            title="Our Vision"
            text="To build a future where every young voice creates meaningful success."
          />
        </div>
      </div>
    </section>
